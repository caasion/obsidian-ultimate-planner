...
import { ISODate, Template, TemplatesByDate } from "./types";
 ...
 */
export function templateForDate(templates: TemplatesByDate, date: ISODate): Template {
...
export function setTemplateRevision(templates: TemplatesByDate, effectiveFrom: ISODate, items: Template): TemplatesByDate {
